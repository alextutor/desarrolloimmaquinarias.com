...
<div class="wrap wsppc-main-box">
		...
		<div class="wsppc-grid-row">
			...
			<div class="wsppc_pro_details ">
				...
				<ul>
					...
					<li>Stick it on overall 18 positions on the page.</li>
	...
	<div class="single-page-position-box">
		...
		<img class="woocommerce-single-page-position-map-image" style="display:none;" src="<?php echo plugins_url('../assets/image/Woocommerce-Gray.png', __FILE__); ?>" alt="Woocommerce Single page position map Image">

...
var Group = /*#__PURE__*/function () {
  ...
  Group_createClass(Group, [{
    ...
    value: function render() {
      ...
      // const labelJSS = this.buttons[this.menuButton].label.setJSS();
      ...
      Object.values(this.buttons).forEach(function (button) {
        if (button.data.id === _this2.menuButton) return; // button.stylesheet.update(JSS);
...
var Label = /*#__PURE__*/function () {
  ...
  Label_createClass(Label, [{
    ...
    value: function setJSS() {
      ...
      this.JSS = {
        label: Label_objectSpread((_objectSpread2 = {
          color: this.data.label_color[0],
          background: this.data.label_inside ? "transparent" : this.data.label_background_color[0],
          "font-size": this.data.label_font_size[0]
        }, Label_defineProperty(_objectSpread2, horizontalProperty, this.data.label_position || "65px"), Label_defineProperty(_objectSpread2, "border-radius", this.data.border_radius_override ? this.data.border_radius_override : this.data.label_border_radius[0]), Label_defineProperty(_objectSpread2, "text-align", this.data.horizontal[0] === "right" ? "end" : "start"), _objectSpread2), this.extraJSS),
        button: {
          "&:hover": {
            "& $label": {
              color: this.data.label_color[1],
              background: this.data.label_inside ? "transparent" : this.data.label_background_color[1]
            }
          }
        }
      };
  ...
  Button_createClass(Button, [{
    ...
    value: function render() {
      ...
      merge_default()(this.JSS, {
        ...
        }), Button_defineProperty(_button, "&:hover", {
          "box-shadow": this.data.box_shadow_disabled ? "none" : undefined
        }), _button)
    ...
    value: function setAction(action) {
      ...
      if (action.addAttr() && action.addAttr().attr) this.element.setAttribute(action.addAttr().attr, action.addAttr().val);
...
;// CONCATENATED MODULE: ./src/js/frontend/Generators/SetSameWidthLabels.js
...
function createGroup() {
  ...
  if (parsedData.label_same_width === true) {
    generators.push(new SetSameWidthLabels());
  }
  /**
   * ====================
   */
...
function parseData(_ref5) {
  ...
  if (is_menu_button) {
    // no need to re-parse menu button
    return {
      parsedData: data,
      extraJSS: extraJSS
    };
  ...
  settingKeys.stylingHover.forEach(function (key) {
    ...
    if (key === "background_color" && result.length === 1) {

...
<div class="ai1wm-modal-sites" role="dialog" tabindex="-1">
	...
	<p>
		<label for="ai1wmme-new-subsite-url">
			...
			<br />
			<input type="url" id="ai1wmme-new-subsite-url" name="options[sites][<?php echo esc_attr( $subsite ); ?>]" value="<?php echo esc_url( $sites[ $subsite ]['New']['HomeURL'] ); ?>" required="required" />
		</label>
	</p>

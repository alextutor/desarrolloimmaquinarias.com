						...
						<p>
							<div class="ai1wm-field">
								<label for="ai1wmme-backups">
									...
									<input style="width: 3em;" type="number" min="0" name="ai1wmme_backups" id="ai1wmme-backups" value="<?php echo intval( $backups ); ?>" />
								</label>
							...
							<div class="ai1wm-field">
								<label for="ai1wmme-total">
									...
									<input style="width: 4em;" type="number" min="0" name="ai1wmme_total" id="ai1wmme-total" value="<?php echo intval( $total ); ?>" />
								</label>
							...
							<div class="ai1wm-field">
								<label for="ai1wmme-days">
									...
									<input style="width: 3em;" type="number" min="0" name="ai1wmme_days" id="ai1wmme-days" value="<?php echo intval( $days ); ?>" />
								</label>

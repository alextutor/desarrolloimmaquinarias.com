...
function enqueue_nf_admin_scripts($hook) {
	...
	// Custom Includes 
	if($hook=='toplevel_page_nex-forms-dashboard' || $hook=='toplevel_page_nex-forms-dashboard-2')
		{
	...
	if($hook=='admin_page_nex-forms-builder')
		{
		if($form)
			{
...
function custom_toolbar_link($wp_admin_bar) {
	...
	if($theme->Name=='NEX-Forms Demo')
		...
		$args = array(
			...
			'href' => 'http://basixonline.net/nex-forms-admin-demo/nex-forms-demo-form/user-test-form-'.$_GET['open_form'].'/?form_id='.$_GET['open_form'].'', 
			'meta' => array(
				'class' => 'nf-test-page', 
